...
export default function Upload() {
  ...
  if (showEditor && resultUrl) {
    return <Editor initialImageUrl={resultUrl} onBack={() => setShowEditor(false)} />;
  }
        ...
        {resultUrl && (
          <div className="upload-result">
            ...
            <div className="result-actions">
              ...
              <a href={resultUrl} download="plano-3d.jpg" className="btn-secondary">
                ⬇ Descargar
              </a>
              <button className="btn-secondary" onClick={handleReset}>
                Subir otro plano
